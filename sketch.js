...
boy = createSprite(70,windowHeight-20,20,20);
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Treasure: "+ treasureCollection,windowWidth/2-40,30);
  }
...
function createDiamonds() {
  ...
  diamonds.lifetime = windowHeight+10;
...
function createJwellery() {
  ...
  jwellery.lifetime = windowHeight+10;
...
function createSword(){
  ...
  sword.scale=0.1;
  sword.velocityY = 3;
  sword.lifetime = windowHeight+10;
